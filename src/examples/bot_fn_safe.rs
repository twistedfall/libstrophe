...
fn version_handler(conn: &mut libstrophe::Connection, stanza: &libstrophe::Stanza) -> bool {
...
fn message_handler(conn: &mut libstrophe::Connection, stanza: &libstrophe::Stanza) -> bool {
